...
modelos = pd.read_csv(os.path.join(BASE, '10_modelos', 'resultados_modelos.csv'))
robustez = pd.read_csv(os.path.join(BASE, '12_validacion', 'robustez_especificaciones.csv'))
moran_biv = pd.read_csv(os.path.join(BASE, '09_estadistica_espacial', 'moran_bivariado.csv'))
proximidad = pd.read_csv(os.path.join(BASE, '05_integracion_espacial', 'proximidad_vs_aleatorio.csv'))
periodos = pd.read_csv(os.path.join(BASE, '12_validacion', 'robustez_periodos_temporales.csv'))
